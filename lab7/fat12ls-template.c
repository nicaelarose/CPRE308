...
void parseDirectory(int iDirOff, int iEntries, unsigned char buffer[])
{
    ...
    for(i = 0; i < (iEntries); i = i + 1)   {
		...
		//Display Attributes
		parseAttributes(string, 11 /*TODO: replace 0 with correct value */);
		printf("%s\t", string);
		
		//Display Time
		parseTime(string, 22 /*TODO: replace 0 with correct value */);
		printf("%s\t", string);
		
		//Display Date
		parseDate(string, 24 /*TODO: replace 0 with correct value */);
		printf("%s\t", string);
		
		//Display Size
		printf("%d\n", 28 /* TODO: replace 0 with actual size */);
    }
